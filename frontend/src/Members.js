                                ...
                                <div className="row rounded cardMember">                                    
                                    <div style={{backgroundColor:val.color, borderTopLeftRadius:"10px", borderTopRightRadius:"10px" }} className="col-12">
                                        <div style={{border :'0', float:"right", verticalAlign: "middle"}}>
                                            <svg onClick={() => changeUser(val.id_member)} className='' data-bs-toggle="modal" data-bs-target="#staticBackdrop" className="mt-3 frameDelete frameActions  p-0 rounded-circle shadow" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" className="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path className='frameDelete frameActions  p-0 rounded-circle shadow'd="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
