...
const Toggle = () => {
    ...
    return (
        ...
        {theme === "light" ?
            <div style={{marginLeft: "281px"}} class="form-check form-switch"><input onClick={() => {change()}} class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" defaultChecked /></div>
            : <div style={{marginLeft: "281px"}} class="form-check form-switch"><input onClick={() => {change()}} class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" /></div>
        }
