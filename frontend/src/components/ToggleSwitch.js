  ...
  return (
    <div className='col-2 col-md-2 col-sm-2 offset-4 offset-md-5 offset-sm-4 offset-lg-7 switchcam'>  
      <div class="form-check form-switch">
        {status === 1 ? 
          <input class="form-check-input" type="checkbox" role="switch" id={id} defaultChecked onClick={() => changeStatusCam(id)} /> :
          status === 2 ? 
          <input class="form-check-input" type="checkbox" role="switch" id={id} onClick={() => changeStatusCam(id)} /> :
