...
function Live({ etat, index, nomCam }) {
  ...
  async function Capture() {
    ...
    let date = new Date();
    let nomFichier = '../public/image-client/frame_' + date.getFullYear() + '-' + date.getMonth() + '-' + date.getDay() + '_' + date.getHours() + '_' + date.getMinutes() + '_' + date.getSeconds() + '.jpeg'

    html2canvas(document.getElementById(`body-${index}`)).then(function (canvas) {
      // document.body.appendChild(canvas);
      let picture = canvas.toDataURL('image/jpeg')
      
      saveAs(picture, nomFichier)
    })
    console.log("capture")
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <img id={`body-${index}`} className="img-thumbnail" alt='visu_live' src={ikram} width="440" height="300" title="Foscam FI8905W" />
        ...
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            ...
            <div className="modal-body" >
              <img class="modal-screenshot" src={`imgClient/${screenshoot}`} alt={'Screenshot'} />
            </div>
