    ...
    return (
        <div className='cadreCamera'>
            ...
            {statusCam === 1 ?
                    ...
                    <div className={"p-1 bg-light align-items-start shadow-sm col-11 col-sm-9 col-md-3 col-lg-8 offset-sm-2 offset-md-1 offset-1 offset-lg-3 cadreBouton"}>
                        <div type="button" data-bs-toggle="modal" data-bs-target={`#modal-${index}`} className="row">
                            <div className="col-1 col-md-1 col-sm-2">
                                <i className="bi bi-camera-video"></i>
                                <div className="col-1 col-sm-2 col-md-1 offset">{nomCam}</div>
