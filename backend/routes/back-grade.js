module.exports = function (app, client) {
  ...
  app.get('/api/gradesInfos', (request, response) => {
     ...
     */
    app.get(
        "/api/grades/:idGrade/cameras",
        (request, response) => {

            const {idGrade} = request.params,

                query = "select PE.id_permission, PE.id_camera, CA.name_camera, allowed, notification \
            ...
            client.query(
                ...
                (error, results1) => {
                    ...
                    VALUES (($1), ($2), 'false', 'false')",
                                        idgrade = results2.rows[0].id_grade,
                                        nbrcamera = results3.rows[0].number_camera;
