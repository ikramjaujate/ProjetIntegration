    ...
    <div className='container'>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-3 offset-3">
          <button type="button" class="btn btn-ligh btn-smt" id="cadre_bouton_photo" >
            {/* <img className='logo'src={photo} alt='capturer'id='photo'></img> */}
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#E0D3D1" class="bi bi-camera" viewBox="0 0 16 16">
        ...
        {/* Bouton Caméra */}
        <div class="col-3 offset-3 ">
          <button type="button" class="btn btn-ligh btn-smt" id="cadre_bouton_video">
           
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#E0D3D1" class="bi bi-camera-video" viewBox="0 0 16 16">
